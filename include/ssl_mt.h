...
#define SQUID_INCLUDE_SSL_MT_H
    ...
    #elif _SQUID_LINUX_
	    #define atomic_cmpset_int(a,b,c)  __sync_bool_compare_and_swap(a,b,c)
	    #define atomic_add_int(a,b)       __sync_fetch_and_add(a,b)
	    #define atomic_load_int(a)        __sync_fetch_and_add(a,0)
    #endif
    ...
    #define ENABLE_SSL_THREAD_ACCEPT_REUSE 1    // keep the created thread for successive ssl_read/write
	...
	// child threads should have higher priority
        ...
        #define SSL_MT_CHILD_IN() \
            atomic_add_int(&atomic_child_is_waiting, 1);
